...
set CMDS clearart completion config edit embedart extractart fetchart fields fish ? help imp im import ls list lyrics mod modify mv move play rm remove splupdate spotify stats upd up update version write
